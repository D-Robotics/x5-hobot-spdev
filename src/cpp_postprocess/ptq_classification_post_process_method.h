...
typedef struct {
   ...
   * @return 0 if success
   */
char* ClassificationPostProcess(ClassificationPostProcessInfo_t *post_info);

void ClassificationDoProcess(hbDNNTensor *tensors, ClassificationPostProcessInfo_t *post_info);
