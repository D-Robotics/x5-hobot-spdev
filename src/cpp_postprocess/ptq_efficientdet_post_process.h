...
#ifndef _POST_PROCESS_EFFICIENTDET_POST_PROCESS_H_
#define _POST_PROCESS_EFFICIENTDET_POST_PROCESS_H_
...
#endif  // _POST_PROCESS_EFFICIENTDET_POST_PROCESS_H_